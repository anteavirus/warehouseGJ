Shader "Custom/Patterns/Stripes"
{
    Properties
    {
        [Header(Pattern Settings)]
        _Scale ("Scale", Range(0.1, 50)) = 5.0
        _StripeWidth ("Stripe Width", Range(0.05, 0.5)) = 0.2
        [Toggle] _Vertical ("Vertical Stripes", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Properties
            float _Scale, _StripeWidth, _Smoothness, _Metallic;
            float _Vertical, _UseXY, _UseXZ, _UseYZ;
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                float coord = _Vertical > 0.5 ? gridPos.x : gridPos.y;
                float stripe = frac(coord);
                bool isStripe = stripe < _StripeWidth;
